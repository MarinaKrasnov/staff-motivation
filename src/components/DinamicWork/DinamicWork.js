...
import styles from './DinamicWork.module.css';
      ...
      <div className={styles.dinamicWork}>
        ...
        <div className={styles.field}>
          <div className={styles.fieldInfo}>
            ...
            <span className={styles.progressPercentage}>{calculatePercentage(myAchievements)}%</span>
          </div>
          <div className={`${styles.progressBar} ${calculateProgressBarColor(myAchievements)}`}>
        ...
        <div className={styles.field}>
          <div className={styles.fieldInfo}>
            ...
            <span className={styles.progressPercentage}>{calculatePercentage(departmentAchievements)}%</span>
          </div>
          <div className={`${styles.progressBar} ${calculateProgressBarColor(departmentAchievements)}`}>
          <div className={styles.progressFill} />
          </div>
        </div>
        <div className={styles.field}>
          <div className={styles.fieldInfo}>
            ...
            <span className={styles.progressPercentage}>{calculatePercentage(organizationAchievements)}%</span>
          </div>
          <div className={`${styles.progressBar} ${calculateProgressBarColor(organizationAchievements)}`}>
          <div className={styles.progressFill} />
          </div>
          <p className={styles.text}>% от плана организации на отчетный период</p>
        </div>
      </div>
    </section>
  );
